...
func BlogIndex(allItems []BlogItems) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for _, items := range allItems {
			...
			var templ_7745c5c3_Var2 string = strconv.FormatInt(int64(items.Year), 10)
			...
			for _, item := range items.Items {
				...
				var templ_7745c5c3_Var4 string = item.LinkText
				...
				var templ_7745c5c3_Var5 string = item.Date.Format("January 02")
...
func BlogContent(title string, date time.Time, tableOfContents templ.Component, content templ.Component) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var8 string = date.Format("2006 Jan 02")
